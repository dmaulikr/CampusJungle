...
BetaBuilder::Tasks.new do |config|
  ...
  config.build_dir = "DerivedData/CampusJungle/Build/Products"
  config.workspace_path = "CampusJungle.xcworkspace"
  config.scheme = "CampusJungle"
  config.app_name = "CampusJungle"
