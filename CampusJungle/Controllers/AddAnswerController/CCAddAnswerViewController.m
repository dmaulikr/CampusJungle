...
{
    CCQuestionHeaderView *headerView = [[CCQuestionHeaderView alloc] initWithQuestionText:self.question.text subject:self.question.subject bottomDividerVisibile:NO];
