...
const struct CCSuccessMessages CCSuccessMessages = {
    ...
    .groupInvitesSent = @"You've successfully sent group invites",
    ...
    .deleteBook = @"You've successfully deleted book",
    .emailDraftSaved = @"Draft was successfully saved",
    .appInviteSent = @"Invites was successfully sent",
    .sendFacebookInvite = @"You've successfully post message to your wall",
