...
- (void)setupLabels
{
    ...
    [self.viewPriceLabel setText:[NSString stringWithFormat:@"View-Only Price: %0.2lf", note.price.doubleValue]];
    [self.fullPriceLabel setText:[NSString stringWithFormat:@"Full Access Price: %0.2lf", note.fullPrice.doubleValue]];
}
